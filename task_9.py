...
def get_url(url):
    ...
    with open(f'Home_work_thread/{filename}', 'wb') as f:
...
#  python task_9.py 'https://images.wallpaperscraft.ru/i# mage/single/chelovek_kub_vsadnik_1087361_1280x720.jpg' 'https://proprikol.ru/wp-content/uploads/2020/11/kartinki-pitony-10.jpg'
